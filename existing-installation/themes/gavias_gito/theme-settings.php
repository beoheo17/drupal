 ...
 */
function gavias_gito_form_system_theme_settings_alter(&$form, &$form_state) {
  $form['#attached']['library'][] = 'gavias_gito/gavias-owl-admin';  
  ...
  $form['general']['link_contact_menu_food'] = array(
    '#type' => 'textfield',
    '#title' => t('Link contact form for menu food'),
    '#default_value' => theme_get_setting('link_contact_menu_food'),
  );

  $form['general']['link_contact_form'] = array(
    '#type' => 'textfield',
    '#title' => t('Link contact form for icon at the bottom website'),
    '#default_value' => theme_get_setting('link_contact_form'),
  );
